...
public class Driver {
        ...
        if (driver == null) {
            switch (ConfigReader.getProperty("browser")) {
                ...
                case "safari":
                    ...
                    break;
                /*case "":
                    WebDriverManager.safaridriver().setup();   eklemek istersek yeni browserlar ekleneebilir
                    driver = new SafariDriver();
                    break;*/
                default:
                    WebDriverManager.chromedriver().setup();
    ...
    public static void closeDriver() {
        if (driver != null) { // driver'a değer atanmışsa kapat
            driver.close();
            driver = null; // Kapandıktan sonra sonraki açmaları
            // garanti altına almak için driver'i tekrar null yaptık
        }
    }
